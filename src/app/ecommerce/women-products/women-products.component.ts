...
export class WomenProductsComponent implements OnInit {
  ...
  loadProducts() {
    this.ecommerceService.getProductGenre('FEMME')
      .subscribe(
        (products: any[]) => {
  ...
  sort(item){
    this.ecommerceService.getProductCategoryAndGenre(item,'FEMME').subscribe(
  ...
  marque(item){
    this.ecommerceService.getProductMarqueAndGenre(item,'FEMME').subscribe(
  ...
  color(item){
    this.ecommerceService.getProductColorAndGenre(item,'FEMME').subscribe(
